	...
	<body>
		...
		<div id="content">
			...
			<div class="box">
				...
				<!-- end box / title -->
				<form method="post" action="image!update.action" enctype="multipart/form-data">
				<input type="hidden" name="cid" value="${image.id }"/>
				<div class="form">
					<div class="fields">
						<div class="field">
							<div class="label">
							...
							<div class="input">
								<input type="text" class="medium required" name="image.name" value="${image.name }">
							</div>
						</div>
						...
						<div class="field">
							...
							<div class="radios" data-radio-value="${image.type }">
								<div class="radio">
						...
						<div class="field">
							...
							<div class="input input-file">
								...
								<img style="vertical-align: middle;" src="${image.url}"/>
							</div>
						</div>
