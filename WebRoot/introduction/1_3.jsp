						...
						<div id="bd-content">
							...
							<div class="fr">
								<div id="arcle1">
								  ...
								  <h2>Models</h2>
							    <table id="arcle1-table2">
									  <tbody>
                                      <tr class="tr2">
									      <td class="td1"> A3 經濟型 </td>
									      <td class="td2"> A5 進階型 </td>
									      <td class="td3"> A7 旗艦型 </td>
								        </tr>
                                         <tr class="tr3">
									      <td width="215" class="td1"><img src="/images/1_3_1.jpg" alt="1"></td>
									      <td width="215"><img src="/images/1_3_2.jpg" alt="2"></td>
									      <td width="215"><img src="/images/1_3_3.jpg" alt="3"></td>
								        </tr>
							...
							<script>
								$("#arcle1 tr").each(function(){
									$(this).children("td:first").addClass("td1");
								});
							</script>
							<div class="clear"></div>
						</div>
